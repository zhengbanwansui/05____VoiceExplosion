...
public class Win extends JFrame implements ActionListener {
    ...
    private JTextPane voiceText;
    private StyledDocument voiceTextDoc;
    private SimpleAttributeSet voiceTextStyle;
    private JTextPane awakeText;
    private StyledDocument awakeTextDoc;
    private SimpleAttributeSet awakeTextStyle;
    ...
    private JRadioButton addOption,delOption,nextOption,lastOption;
    private JPanel awakeSentenceEditPanel;
    private ArrayList<String> orderNextString;
    private ArrayList<String> orderLastString;
     ...
     * JFrame内容组件初始化并添加
     * 详细结构如下 :
     * JFrame->rootPanel--pptTargetPlace拖拽目标区域
     *                  --dragArea顶栏可拖拽--small最小化
     *                                     --out退出
     *                  --voiceText语音识别文字记录
     *                  pageJLabel当前页数
     *                  compareJLabel当前页配准进度
     *
     */
    private void initInside() {
        ...
        // 第三部分 翻页指令编辑区
        awakeSentenceEditPanel = new JPanel();
